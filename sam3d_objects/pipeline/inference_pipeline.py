    ...
    def __init__(
        ...
        with self.device:
            ...
            if slat_condition_embedder is not None:
                self.condition_embedders['slat_condition_embedder'] = slat_condition_embedder
            ...
            if self.compile_model:
                if not self.load_slat:
                    logger.warning(
                        'compile_model requested with load_slat=False; skipping compilation'
                    )
                else:
